...
var LocalFSAdapter = require('./local-fs-adapter');
var DropboxFSAdapter = require('./dropbox-fs-adapter');
...
function Scraper (options) {
  ...
  if (options.fsAdaptor) {
    self.fsAdapter = new options.fsAdaptor(self.options);
  } else {
    self.fsAdaptor = new LocalFSAdapter(self.options);
  }
...
Scraper.LocalFSAdapter = LocalFSAdapter;
Scraper.DropboxFSAdapter = DropboxFSAdapter;
